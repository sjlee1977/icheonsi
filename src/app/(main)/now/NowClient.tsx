...
import type { TrainInfo } from '@/lib/gyeonggang-timetable'
...
export default function NowClient({ initialWeather, initialSubway }: Props) {
  ...
  const [subwayData, setSubwayData] = useState<SubwayData>(initialSubway)
  const [mapTab, setMapTab] = useState<'pharmacy' | 'hospital'>('pharmacy')
  const [loading, setLoading] = useState({ medical: true })
